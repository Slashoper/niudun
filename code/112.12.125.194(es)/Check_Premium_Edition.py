...
query_domain = [ "*81.cn", "*mod.gov.cn", "*chinamil.com.cn",  "*fastweb.com.cn", "*chinahighway.com", "jk.anquan.io", "*yinhu.com", "*dingliangame.com"]
#query_domain = ["*52cp.cn", "*190888.com", "*koo.cn", "*teenker.com", "*mfniu.com", "*makepolo.com", "*itpub.net", "*chinaunix.net", "*ipip.net", "*81.cn", "*mod.gov.cn", "*chinamil.com.cn", "*bangirls.com", "*vshow30.net", "*fastweb.com.cn", "*chinahighway.com", "*fwmob.com", "*bdqn.cn", "*ppmoney.com", "jk.anquan.io", "*koolearn.com", "*duotai.org", "*kgc.cn", "*nyato.com", "*17mf.com", "*zm518.cn", "*cguardian.com"]
#query_domain = ["*52cp.cn", "*jyblc.cn", "*190888.com", "*koo.cn", "*teenker.com", "*mfniu.com", "*makepolo.com", "*itpub.net", "*chinaunix.net", "*ipip.net", "*81.cn", "*mod.gov.cn", "*chinamil.com.cn", "*bangirls.com", "*vshow30.net", "*fastweb.com.cn", "*chinahighway.com", "*fwmob.com", "*bdqn.cn", "*ppmoney.com", "jk.anquan.io", "*koolearn.com", "*duotai.org", "*kgc.cn", "*nyato.com", "*17mf.com", "*88mf.com"]

#
#
# delete chinahighway.com
#query_domain = ["*52cp.cn", "*jyblc.cn", "*190888.com", "*koo.cn", "*teenker.com", "*mfniu.com", "*makepolo.com", "*itpub.net", "*chinaunix.net", "*ipip.net", "*81.cn", "*mod.gov.cn", "*chinamil.com.cn", "*bangirls.com", "*vshow30.net", "*fastweb.com.cn", "*fwmob.com", "*bdqn.cn", "*ppmoney.com", "jk.anquan.io", "*koolearn.com", "*duotai.org", "*kgc.cn", "*nyato.com"]
# 
#
# delete bdqn.cn, kgc.cn
#query_domain = ["*52cp.cn", "*jyblc.cn", "*190888.com", "*koo.cn", "*teenker.com", "*mfniu.com", "*makepolo.com", "*itpub.net", "*chinaunix.net", "*ipip.net", "*81.cn", "*mod.gov.cn", "*chinamil.com.cn", "*bangirls.com", "*vshow30.net", "*fastweb.com.cn", "*chinahighway.com", "*fwmob.com", "*ppmoney.com", "jk.anquan.io", "*koolearn.com", "*duotai.org", "*nyato.com"]
...
def Query_Results(write_result) :
    ...
    result = open('/tmp/resut_send_qq.log', 'a+')
    ...
    for domain, http_5xx_count in write_result.iteritems():
        ...
        if len(http_5xx_count) > 1 :
            ...
            for i in http_5xx_count[0:-1] :
                ...
                if (doc_count >= 300) or (total_percentage_5xx >= 3):
