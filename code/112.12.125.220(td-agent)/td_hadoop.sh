#!/bin/bash
PATH=/usr/local/bin:/usr/local/bin:/usr/lib64/qt-3.3/bin:/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/jdk1.8.0_65/bin:/root/bin:/usr/local/jdk1.8.0_65/jre/lib/amd64/jli:/usr/local/kafka/bin:/usr/local/zookeeper/bin:/usr/local/jdk1.8.0_65/bin:/root/bin:/usr/local/jdk1.8.0_65/jre/lib/amd64/jli:/usr/local/kafka/bin:/usr/local/zookeeper/bin
